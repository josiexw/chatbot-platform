"""
URL configuration for multi_llms project.
...
from chatbot.views import get_preview, get_assistant, send_message
from customization.views import make_assistant, list_assistants, delete_assistant, edit_assistant

urlpatterns = [
    path("admin/", admin.site.urls),
    path('chatbot/', include('chatbot.urls')),
    path('api/get_preview', get_preview, name='get_preview'),
